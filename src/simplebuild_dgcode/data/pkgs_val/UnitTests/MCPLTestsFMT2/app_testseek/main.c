...
int main(int argc,char**argv) {
  ...
  int ec;
  if ((ec=testskip(core_finddata("MCPLTestsFMT2","reffile_1.mcpl"))))
    return ec;
  if ((ec=testskip(core_finddata("MCPLTestsFMT2","reffile_skip123.mcpl"))))
    return ec;
  if ((ec=testskip(core_finddata("MCPLTestsFMT2","reffile_skip123.mcpl.gz"))))
    return ec;
  if ((ec=testskip(core_finddata("MCPLTestsFMT2","reffile_crash.mcpl"))))
    return ec;
  if ((ec=testskip(core_finddata("MCPLTestsFMT2","reffile_empty.mcpl"))))
    return ec;
  return 0;
}
