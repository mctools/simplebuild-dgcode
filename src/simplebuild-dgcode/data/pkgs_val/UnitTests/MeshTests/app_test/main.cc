...
template <> double expected_precision<float>() { return 1.0e-7; }
...
int main(int,char**) {
  ...
  //1D test:
  Mesh::MeshFiller<1> m1( {10}, {0.0}, {10.0} );
  doFill(m1, 17.0, {4.5});
  test_and_dump(m1);
  ...
  many_1d_tests<std::vector<double> >();
  many_1d_tests<std::vector<float> >();
  test_1d<std::vector<double> >(3, 0.0, 3.0,0.5,1.5);
  ...
  test_2d<std::vector<double> >(3, 0.0, 3.0,   3, 0.0, 3.0,    0.0, 0.0,    4.0, 4.0);
  test_2d<std::vector<double> >(3, 0.0, 3.0,   3, 0.0, 3.0,    4.0, 4.0,    0.0, 0.0);
  test_2d<std::vector<double> >(3, 0.0, 3.0,   3, 0.0, 3.0,    3.0, 3.0,    0.0, 0.0);
  test_2d<std::vector<double> >(3, 0.0, 3.0,   3, 0.0, 3.0,    0.0, 0.0,    3.0, 3.0);
  test_2d<std::vector<float> >(3, 0.0, 3.0,   3, 0.0, 3.0,    0.0, 0.0,    4.0, 4.0);
  test_2d<std::vector<double> >(3, 0.0, 3.0,   3, 0.0, 3.0,    -1.0, -1.0,    4.0, 4.0);
  test_2d<std::vector<double> >(3, 0.0, 3.0,   3, 0.0, 3.0,    4.0, 4.0,    -1.0, -1.0);
  test_2d<std::vector<double> >(3, 0.0, 3.0,   3, 0.0, 3.0,    0.0, 1.0,    4.0, 5.0);
  test_2d<std::vector<float> >(3, 0.0, 3.0,   3, 0.0, 3.0,    0.0, 1.0,    4.0, 5.0);
  test_2d<std::vector<double> >(3, 0.0, 3.0,   3, 0.0, 3.0,    0.0, 0.0+1e-6,1.0, 1.0+1e-6);
  test_2d<std::vector<double> >(3, 0.0, 3.0,   3, 0.0, 3.0,    0.0, 0.0+1e-9,1.0, 1.0+1e-9);
  test_2d<std::vector<double> >(3, 0.0, 3.0,   3, 0.0, 3.0,    0.0, 0.0+0.2e-9,1.0, 1.0+0.2e-9);
  test_2d<std::vector<double> >(3, 0.0, 3.0,   3, 0.0, 3.0,    0.0, 0.0+0.2e-11,1.0, 1.0+0.2e-11);
  test_2d<std::vector<double> >(3, 0.0, 3.0,   3, 0.0, 3.0,    2.0, 0.5,    3.0, 1.0+1.0e-13);
  test_2d<std::vector<double> >(3, 0.0, 3.0, 3, 0.0, 3.0, 0.5,2.5, 1.5,1.5);
  test_2d<std::vector<double> >(3, 0.0, 3.0, 3, 0.0, 3.0, 1.5,1.5, 0.5,2.5);
  test_2d<std::vector<double> >(3, 0.0, 3.0,2, 0.0, 2.0,2.5, 1.0,-0.5,1.0-1e-13);
  const long bignum = 10000000;
  test_2d<std::vector<double> >(bignum, 0.0, 1e7,   2, 0.0, 2.0, (bignum-1)-1.0e-9, 0.9, (bignum-1)+1.0e-9, 0.1);
  ...
  test_3d<std::vector<double> >(3, 0.0, 3.0, 3, 0.0, 3.0, 3, 0.0, 3.0,
                  0.0,0.0,0.0,3.0,3.0,3.0);

  test_3d<std::vector<double> >(3, 0.0, 30.0,3, -1.0, 2.0,3, 0.0, 300.0,
  ...
  test_3d<std::vector<double> >( 3, 0.0, 3.0, 5, 0.0, 5.0, 2, 0.0, 2.0,
  ...
  test_3d<std::vector<double> >(3, 0.0, 3.0,
                  1, 0.0, 5.0,
                  1, 0.0, 2.0,
                  0.5,2.0,1.0,
                  1.5,2.0,1.0);
  ...
  for (unsigned i = 0; i < 1001; ++i) {
    ...
    test_3d<std::vector<double> >(3, lowx, highx,
                    5, lowy, highy,
                    2, lowz, highz,
                    rayl_x,rayl_y,rayl_z,
                    rayh_x,rayh_y,rayh_z,
